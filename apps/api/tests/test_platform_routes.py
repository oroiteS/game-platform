...
def test_room_created_with_sqlite_backing_is_cleared_on_app_restart(tmp_path):
    ...
    # Starting a new app instance calls delete_all_rooms() on startup,
    # so the previously created room should no longer exist.
